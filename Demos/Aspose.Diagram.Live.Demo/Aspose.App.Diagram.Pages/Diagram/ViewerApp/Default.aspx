﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Async="true" Inherits="Aspose.App.Diagram.Pages.ViewerApp.Default" %>
...
<head runat="server">
    ...
    <link href="/diagram/Resources/images/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />

	<script src="/diagram/ViewerApp/js/custom.js"></script>
	<script>
	...
	<link href="/diagram/ViewerApp/css/effect-light.min.css" rel="stylesheet" />
	<link href="/diagram/ViewerApp/css/quantumui.min.css?v1.4" rel="stylesheet" />
	<script src="/diagram/ViewerApp/js/moment.min.js"></script>
	<script src="/diagram/ViewerApp/js/angular.min.js"></script>
	<script src="/diagram/ViewerApp/js/angular-sanitize.min.js"></script>
	<script src="/diagram/ViewerApp/js/angular-animate.min.js"></script>
	<script src="/diagram/ViewerApp/js/angular-resource.min.js"></script>

 	<script src="/diagram/ViewerApp/js/quantumui-all.min.js?v1.4"></script>
	<script src="/diagram/ViewerApp/js/icons.js"></script>
	<script src="/diagram/ViewerApp/js/app.js?v1.6"></script>
	 <% if (Aspose.App.Diagram.Pages.Config.AppConfiguration.PageUrl.Contains("://products.aspose.app"))
       { %>
...
<body oncontextmenu="return false" data-ng-controller="ViewerAPIController as ctrl" style="height: 100vh; overflow: hidden!important;">
			...
			<div class="container-fluid" style="padding-right: 5px!important;">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="#" style="padding: 5px 15px;">
						<img src="/diagram/ViewerApp/images/Aspose-logo.jpg" alt="Aspose Document Viewer App" />
					</a>
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							...
							<ul class="dropdown-menu" tabindex="-1" role="menu">
								<li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=pdf"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As PDF</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=png"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As PNG</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=svg"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As SVG</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=xps"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As XPS</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=html"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As HTML</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=docx"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As DOCX</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="<%= apiUrl%>Storage/ConvertDownload?file=<%=HttpUtility.HtmlEncode(downloadFileName)%>&folder=<%=folderName%>&outputType=pptx"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As PPTX</a></li>
							</ul>
						</li>
						<li>
	...
	<div name="dvPages" class="content-wrapper container-fluid" infinityscroll="NextPage()" style="height: 100vh; padding-top: 55px!important; width: auto!important; overflow: auto!important; background: #fff; background-image: url('/diagram/viewerapp/images/loader.gif'); background-repeat: no-repeat; background-position: center;">
