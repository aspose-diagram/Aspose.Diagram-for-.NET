...
{
	/// <summary>
	/// Wrapper class for Aspose.Diagram Tools context access to Pages and controls
	/// </summary>
	public class AsposeDiagramContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeDiagramContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeDiagramContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeDiagramContext atcc { set { atc = value; } }
		internal static AsposeDiagramContext Current
		{
			get { return atc; }
		}
