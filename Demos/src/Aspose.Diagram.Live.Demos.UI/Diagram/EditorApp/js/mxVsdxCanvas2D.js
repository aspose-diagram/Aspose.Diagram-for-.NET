 ...
 */
mxVsdxCanvas2D.prototype.init = function ()
{
	this.filesLoading = 0;
};
...
{
	return (this.xmlDoc.createElementNS != null) ? this.xmlDoc.createElementNS(Vsdx.prototype.XMLNS, name) :
...
{
	return this.createCellElem(name, val / Vsdx.prototype.CONVERSION_FACTOR, formula);
};
...
{
	return this.createRowRel(type, index, x / Vsdx.prototype.CONVERSION_FACTOR, y / Vsdx.prototype.CONVERSION_FACTOR,
			a / Vsdx.prototype.CONVERSION_FACTOR, b / Vsdx.prototype.CONVERSION_FACTOR,
			c / Vsdx.prototype.CONVERSION_FACTOR, d / Vsdx.prototype.CONVERSION_FACTOR,
			xF, yF, aF, bF, cF, dF);
};
